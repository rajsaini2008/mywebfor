    ...
    const fetchLegalContent = async () => {
      ...
      try {
        ...
        if (data.success && Array.isArray(data.data)) {
          ...
          // Set terms content
          setTermsContent(contentMap["termsContent"] || getDefaultTermsContent())
          setPrivacyContent(contentMap["privacyContent"] || getDefaultPrivacyContent())
          setRefundContent(contentMap["refundContent"] || getDefaultRefundContent())
          setDisclaimerContent(contentMap["disclaimerContent"] || getDefaultDisclaimerContent())
        }
      } catch (error) {
        ...
        setRefundContent(getDefaultRefundContent())
        setDisclaimerContent(getDefaultDisclaimerContent())
      } finally {
        setIsLoading(false)
      }
    }
...
function getDefaultRefundContent() {
  return `
